...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN', 'mysql://root:compucorp123@localhost/compucorp?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:compucorp123@localhost:3306/compucorp_civicrm?new_link=true');
  }
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '0dd846fe821c464c64fe556bae85fb7b');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Users/nmeegama/work_repo/compucorp/sites/default/files/civicrm/templates_c//mail.log');
// }
