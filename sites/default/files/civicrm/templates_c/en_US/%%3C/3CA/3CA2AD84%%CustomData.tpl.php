<?php /* Smarty version 2.6.30, created on 2017-11-10 14:50:17
         compiled from CRM/Contact/Page/View/CustomData.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Page/View/CustomData.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Page/View/CustomData.tpl', 53, false),array('block', 'crmRegion', 'CRM/Contact/Page/View/CustomData.tpl', 72, false),array('function', 'crmURL', 'CRM/Contact/Page/View/CustomData.tpl', 55, false),array('modifier', 'cat', 'CRM/Contact/Page/View/CustomData.tpl', 71, false),)), $this); ?>
...
<?php echo ''; ?><?php if ($this->_tpl_vars['displayStyle'] != 'tableOriented' && ( $this->_tpl_vars['action'] == 16 || $this->_tpl_vars['action'] == 4 )): ?><?php echo ' '; ?><?php echo ''; ?><?php $this->assign('customGroupDisplayDone', 1); ?><?php echo '<div class="form-item">'; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
?>
    ...
    <?php $this->_tag_stack[] = array('crmRegion', array('name' => $this->_tpl_vars['customRegion'])); $_block_repeat=true;smarty_block_crmRegion($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
      <?php if ($this->_tpl_vars['customGroup']['help_pre'] && ! $this->_tpl_vars['customGroupDisplayDone']): ?>
...
unset($_smarty_tpl_vars);
 ?>
      ...
      <?php endif; ?>
      <?php if ($this->_tpl_vars['customGroup']['help_post'] && ! $this->_tpl_vars['customGroupDisplayDone']): ?>
